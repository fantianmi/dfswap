...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  const activeFarms = farmsLP.filter((farm) => !!farm.isTokenOnly === !!tokenMode)
  ...
  const farmsList = useCallback(
    (farmsToDisplay, removed: boolean) => {
      ...
      const farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        //   return farm
        // }
        const cakeRewardPerBlock = new BigNumber(farm.bdogsPerBlock || 1).times(new BigNumber(farm.poolWeight)) .div(new BigNumber(10).pow(18))
